...
![Open Folder VS Code](./.github/images/setup-2.png)

### 3. Open a terminal in Visual Studio Code.

Open a terminal inside of VSCode.

![Open Terminal Console](./.github/images/setup-3.png)
...
![Fix permissions](./.github/images/setup-4.png)
...
![Starting node](./.github/images/usage-start.png)
...
![Open new terminal](./.github/images/usage-check-1.png)

And then click on the new terminal.

![Navigate to new terminal](./.github/images/usage-check-1-b.png)
...
![New keys and addresses](./.github/images/doing-1.png)
